...
import './registerScrRegionBody.dart';

//importing themes
import '../../../../Themes/color.dart';

class RegisterRegionScreenDesktop extends StatelessWidget {
  // The login page is the main page of our authentication process

  const RegisterRegionScreenDesktop();

  static const id = 'RegisterRegionScreen';

  static Route comeToPage() {
    return PageRouteBuilder(
      pageBuilder: (context, animatio1, aniamtion2) =>
          RegisterRegionScreenDesktop(),
